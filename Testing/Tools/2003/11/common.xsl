...
<!--
  ...
  Copyright (c) 2002 - 2003 IBM Corporation.  All rights reserved.
...
<xsl:template name="copyright">
  ...
  <p>Copyright (c) 2002-2003 by The Web Services-Interoperability Organization and Certain of its Members. All Rights Reserved.</p>
...
<xsl:template name="notice"> 
  <hr style="color : black;"/>
  <a name="Notice"><h4>Notice</h4></a><p/>
...
<a href="mailto:wsi-test-comments@ws-i.org">wsi-test-comments@ws-i.org</a>.
</p>
</xsl:template>
</xsl:stylesheet>
